...
& $csc /nologo /target:winexe /optimize+ /out:"$OutputDirectory\SamKookLauncher.exe" /reference:System.dll /reference:System.Core.dll /reference:System.Drawing.dll /reference:System.Windows.Forms.dll /reference:System.Net.Http.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll "/resource:$here\selection36.manifest,selection36.manifest" "/resource:$here\observer.manifest,observer.manifest" "/resource:$here\sync.manifest,sync.manifest" "$here\SamKookLauncher.cs" "$here\QueuePatch.cs" "$here\SelectionPatch.cs" "$here\GameQualityPatch.cs" "$here\ObserverPatch.cs" "$here\NetworkLifecyclePatch.cs" "$here\SyncSafetyPatch.cs" "$here\LegacyHash.cs" "$here\GameOptions.cs" "$here\MapPreview.cs" "$here\MapDownloads.cs"
