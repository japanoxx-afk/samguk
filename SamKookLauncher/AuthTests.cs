...
static class AuthTests {
 ...
 static int Main(){
  ...
  try{using(var c=new TcpClient("127.0.0.1",7104))using(var s=c.GetStream()){
  ...
  }Console.WriteLine("PASS: game hash vectors; create/retry/conflict; bad proof rejected; good proof and channel list accepted");return 0;}
